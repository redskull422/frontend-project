function Container (){
    return(
        ...
        <div className="container">
            ...
            <div className = "info-box animate__animated animate__backInDown" id="dragonborn">
            ...
            <div className = "info-box animate__animated animate__backInDown" id="custom">
                <img className="Dwarf-image" src="Human.jpeg" />
                <div className="inside-box">
                    <h2>Information</h2>
                    Build You Own Charachter
                    Make You Own Legend
                    <br/>
                    <CustomHandler/>
                </div>
